...
public class C01 {
    ...
    public static void main(String[] args) {
        ...
        // sonucu yazdırınız
        WebElement sonuc = driver.findElement(By.xpath("//span[@id='answer']")); //iki kutucuga girdigimiz 20 ve 30 sayilari calculate ile toplandi ve ekranda Answer:50 seklinde
        //sonucun yazildigini gorduk. Bizden sonucu yazdirmamiz istendiginden Answer:50 uzerine gelip onun locate'ini aldik.
